...
export function FacebookIcon({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M9.198 21.5h4v-8.01h2.604l.396-3.024h-3v-1.93c0-.875.243-1.472 1.498-1.472h1.602v-2.71c-.278-.037-1.23-.12-2.338-.12-2.313 0-3.896 1.412-3.896 4.004v2.228H7.5v3.024h2.698v8.01Z" />
    </svg>
  );
}
